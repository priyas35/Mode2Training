...
public void testPlaceOrder(){
	assertEquals("Order Placed Successfully...", StockBAL.placeOrderBal("S002", 2));
	assertEquals("Insufficent Quantity...", StockBAL.placeOrderBal("S003", 2000));
	assertEquals("StockID not found...", StockBAL.placeOrderBal("f003", 2000));
	...
	public void testcreateStock(){
		...
		assertEquals("created successfully", StockBAL.createStockBal(stock));
