...
public class RetrieveLogic
{
    ...
    public void retrieveEmployee()
    {
        ...
        List<Employee> employeeList = employeeRepository.findEmpByCountryAndSortByState("India", "state");
		...
		/*
		 * List<Employee>
		 * emplist=employeeRepository.findEmpByCountryAndSortByState("India", "state");
		 * for(Employee employee : emplist) { System.out.println(emplist); }
		 */
